...
function EFFECT:Render()
    ...
    render.DrawBox(pos, Angle(0, 0, 0), Vector(-offs, -offs, 0), Vector(offs, offs, self.hei * fraction), Color(100, 255, 100, 10 * fraction))
    render.DrawBox(pos, Angle(0, 0, 0), Vector(-offs_raw, -offs_raw, 0), Vector(offs_raw, offs_raw, self.hei), Color(55, 255, 55, 20 * fraction))
end