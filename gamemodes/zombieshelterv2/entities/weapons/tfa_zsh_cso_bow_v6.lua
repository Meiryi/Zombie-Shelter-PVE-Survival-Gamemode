...
SWEP.PrintName				= "#zshelter.weapon.compound_bow_expert"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Damage		= 65 --effective damage				-- Damage, in standard damage points.
