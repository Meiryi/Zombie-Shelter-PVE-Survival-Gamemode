...
SWEP.PrintName				= "#zshelter.weapon.m4a1_dark_knight"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Spread		= .0038					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
SWEP.Primary.IronAccuracy = .00304	-- Ironsight accuracy, should be the same for shotguns
...
function SWEP:Think2(...)
	if self:GetIronSightsProgress() <= 0.5 and self:GetCSO_SwitchState() then
		...
		self.Primary_TFA.KickUp	= 0.2
        self.Primary_TFA.KickDown	= 0.14
