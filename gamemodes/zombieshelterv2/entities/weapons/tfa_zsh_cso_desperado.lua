...
SWEP.PrintName = "#zshelter.weapon.python_desperado" -- Weapon name (Shown on HUD)	
...
function SWEP:SecondaryAttack( )
	...
	if f then
		...
		self.Ammo_1 = self:Clip1()
		self:SetClip1(self.Ammo_2)
	else
		self:SendViewModelAnim( ACT_VM_DEPLOY )
		self.Ammo_2 = self:Clip1()
		self:SetClip1(self.Ammo_1)
	end
