...
SWEP.PrintName				= "#zshelter.weapon.sg552_lycanthrope"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.IronAccuracy = .00105	-- Ironsight accuracy, should be the same for shotguns
