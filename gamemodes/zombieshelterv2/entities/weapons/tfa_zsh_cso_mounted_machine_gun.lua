...
SWEP.PrintName              = "#zshelter.weapon.mounted_machine_gun"     -- Weapon name (Shown on HUD)
...
TFA.AddFireSound( "MountedGun.Fire", "emplacement/cso_mountgun/fire.wav" )

--[[WEAPON HANDLING]]--

--Firing related
SWEP.Primary.Sound          = Sound("MountedGun.Fire")  -- This is the sound of the weapon, when you shoot.
...
SWEP.NZPaPName              = "Mounted Machine Gun"
...
SWEP.MoveSpeed = 0.01 --Multiply the player's movespeed by this.
SWEP.IronSightsMoveSpeed = 0.01 --Multiply the player's movespeed by this when sighting.
...
SWEP.ViewModel          = "models/tfa_cso/emplacement/c_csomountgun.mdl" --Viewmodel path
...
SWEP.WorldModel         = "models/weapons/cstrike/c_pist_elite.mdl" -- Worldmodel path
...
SWEP.DrySound = "emplacement/cso_mountgun/cso_mountgun/empty.wav"
...
if CLIENT then
    SWEP.WepSelectIconCSO = Material("vgui/killicons/tfa_cso_mountedgun")
