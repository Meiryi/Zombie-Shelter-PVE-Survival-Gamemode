...
SWEP.PrintName				= "#zshelter.weapon.triple_tactical_knife"		-- Weapon name (Shown on HUD)
...
SWEP.Type	= "#zshelter.type.secondary_melee"
...
SWEP.Primary.Projectile = "zsh_tacticalknife_ex2"
SWEP.Primary.ProjectileModel = "models/weapons/tfa_cso/w_tknifeex2.mdl"
SWEP.Primary.ProjectileVelocity = 3000 -- 76 meters to inches * 4/3 ( 16 / 12 hammer to inches )
...
SWEP.Primary.Spread		= 0.2					--This is hip-fire acuracy.  Less is more (1 is horribly awful, .0001 is close to perfect)
...
function SWEP:Think2(...)
	if(self.NextRegen < CurTime() && SERVER) then
		self.Owner:GiveAmmo(1, self:GetPrimaryAmmoType(), true)
