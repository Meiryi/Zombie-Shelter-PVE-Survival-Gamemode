...
function ZShelter.CreateDefaultItems()
			...
			ZShelter.AddItem("Pistol", "tfa_zsh_cso_thanatos1", "Thanatos 1", 45, 42, 1, true, {}, nil, 1.5, -1, -1, 2)
			...
			ZShelter.AddItem("Shotgun", "tfa_zsh_cso_thanatos11", "Thanatos 11", 44, 51, 1, true, {"Beginner Gun Mastery"}, nil, 8, -1, -1, 2)
