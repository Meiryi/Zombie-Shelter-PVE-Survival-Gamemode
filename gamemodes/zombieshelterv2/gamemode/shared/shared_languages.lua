...
ZShelter.L("#ServerListHint", {
	...
	["ru"] = "На серверах в этом списке запущен режим Zombie Shelter v2.",
...
ZShelter.L("#SpawnPointDedicated", {
	...
	["ru"] = "Выделенная точка появления врагов",
...
ZShelter.L("#SpawnPointDedicatedDesc", {
	...
	["ru"] = "ВЫДЕЛЕННАЯ точка появления, разместив любого из врагов, они будут появляться в этом заданном месте.",
...
ZShelter.L("#MeleeDMG", {
	...
	["ru"] = "Ломается только в ближнем бою",
